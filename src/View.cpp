...
void View::fillWithTreasure(){
    vector<std::pair<int, int>> treasurePos = {
        ...
        {3,2},{3,4},{3,6},{4,7},{4,8},{4,9}, //1之前
        {5,1},{5,8},{6,1},{6,8},{7,1}, //1
        {8,6},{9,2},{9,6},{10,5},{10,9},{11,0}, //第二個1之前
        {12,1},{13,1},{14,9}, //第二個1
        {15,0},{15,1},{16,2},{17,3},{17,4},{18,3}, //3之前
        {19,0},{20,0},{20,1},{21,0},{21,8},{21,9},{22,1},{22,8}, //3
        {24,6},{25,3},{25,4},{26,2},{26,3},{27,1}, //第一個O之前
        {28,0},{29,1},{30,1},{31,1},{32,0},{33,0},{33,1}, //第一個O
        {34,0},{35,6},{35,8},{36,4},{36,7},{37,1}, //第二個O之前
        {38,0},{39,1},{40,1},{41,1},{42,0},{43,0},{43,1}, //第二個O
        {44,0},{45,6},{45,8},{46,4},{46,7},{47,1}, //P之前
        {48,0},{49,1},{50,1},{51,1},{52,0},{53,0}, //P
        {54,0},{55,6},{55,8},{56,4},{56,7},{57,1}, //P之後
        {58,0},{58,1},
        {58,2},{58,3},{59,4}
    };
